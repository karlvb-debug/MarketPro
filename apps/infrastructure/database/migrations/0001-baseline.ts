...
// The complete schema as of the introduction of versioned migrations.
// Fully idempotent (IF NOT EXISTS everywhere) so it applies cleanly to
// databases created before migration tracking existed.
