...
import { loadFieldDefinitions, validateCustomFields, findUniqueViolations } from '@repo/core/custom-fields';
import { parseRules, compileRules, RuleValidationError } from '@repo/core/rules';
import { buildContactTimeline, getConsentState } from '@repo/core/timeline';
import { findDuplicateClusters } from '@repo/core/duplicates';
import { mergeContacts } from '@repo/core/merge';
import { applyBulkAction, Selection, BulkAction, buildSelectionClause } from '@repo/core/bulk';
import { getDb, getPool, respond, getWorkspaceId, getUserId, requireRole, isSuperAdmin, methodToAction } from '../lib/db';
import { contacts, adminAuditLog, segments, contactSegment, suppressionList } from '@repo/core/schema';
